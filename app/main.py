...
@app.get("/probes/rsrp/{serial}")
def get_avg_probe_rsrp(serial: str):
    """Return average RSRP for a given probe SERIAL and time range."""
    result = get_probe_rsrp(serial)
    logger.info(f"Average RSRP for {serial}: {result['average_rsrp']}")
    return result
...
@app.get("/probes/sinr/{serial}")
def get_avg_probe_sinr(serial: str):
    """Return average SINR for a given probe SERIAL and time range."""
    result = get_probe_sinr(serial)
    logger.info(f"Average SINR for {serial}: {result['average_sinr']}")
    return result

@app.get("/probes/sinr/live/{serial}")
def get_instant_probe_sinr(serial: str):
    """Return instant SINR for a given probe SERIAL."""
    result = get_instant_probe_sinr_data(serial)
...
def liveview_4skelion(request: Request):
    ...
    try:
        return templates.TemplateResponse(request=request, name="4skelion/liveview.html")
    except Exception:
...
def detailed_liveview_4skelion(request: Request):
    ...
    try:
        return templates.TemplateResponse(request=request, name="4skelion/detailed-liveview.html")
    except Exception:
        return templates.TemplateResponse(request=request, name="coming_soon.html")
...
def liveview_3skelion(request: Request):
    """Render the live view UI."""
    try:
        return templates.TemplateResponse(request=request, name="3skelion/liveview.html")
    except Exception:
        return templates.TemplateResponse(request=request, name="coming_soon.html")
...
def detailed_liveview_3skelion(request: Request):
    """Render the detailed live view UI."""
    try:
        return templates.TemplateResponse(request=request, name="3skelion/detailed-liveview.html")
    except Exception:
        return templates.TemplateResponse(request=request, name="coming_soon.html")
...
def liveview_f_qual(request: Request):
    """Render the live view UI."""
    try:
        return templates.TemplateResponse(request=request, name="f-qual/liveview.html")
    except Exception:
        return templates.TemplateResponse(request=request, name="coming_soon.html")
...
def detailed_liveview_f_qual(request: Request):
    """Render the detailed live view UI."""
    try:
        return templates.TemplateResponse(request=request, name="f-qual/detailed-liveview.html")
    except Exception:
        return templates.TemplateResponse(request=request, name="coming_soon.html")
...
def dashboard_f_qual(request: Request):
    ...
    try:
        return templates.TemplateResponse(request=request, name="f-qual/dashboard.html", context={"request": request})
    except Exception:
...
def communication_alarms_4skelion(request: Request):
    try:
        return templates.TemplateResponse(request=request, name="4skelion/communication_alarm.html", context={"request": request})
    except Exception:
        return templates.TemplateResponse(request=request, name="coming_soon.html", context={"request": request})
...
def communication_alarms_3skelion(request: Request):
    try:
        return templates.TemplateResponse(request=request, name="3skelion/communication_alarm.html", context={"request": request})
    except Exception:
        return templates.TemplateResponse(request=request, name="coming_soon.html", context={"request": request})
...
def communication_alarms_f_qual(request: Request):
    try:
        return templates.TemplateResponse(request=request, name="f-qual/communication_alarm.html", context={"request": request})
    except Exception:
        return templates.TemplateResponse(request=request, name="coming_soon.html", context={"request": request})
...
def total_alarms_4skelion(request: Request):
    try:
        return templates.TemplateResponse(request=request, name="4skelion/alarm_summary.html", context={"request": request})
    except Exception:
        return templates.TemplateResponse(request=request, name="coming_soon.html", context={"request": request})
...
def total_alarms_3skelion(request: Request):
    try:
        return templates.TemplateResponse(request=request, name="3skelion/alarm_summary.html", context={"request": request})
    except Exception:
        return templates.TemplateResponse(request=request, name="coming_soon.html", context={"request": request})
...
def total_alarms_f_qual(request: Request):
    try:
        return templates.TemplateResponse(request=request, name="f-qual/alarm_summary.html", context={"request": request})
    except Exception:
        return templates.TemplateResponse(request=request, name="coming_soon.html", context={"request": request})
...
def performance_alarms_4skelion(request: Request):
    try:
        return templates.TemplateResponse(request=request, name="4skelion/performance_alarm.html", context={"request": request})
    except Exception:
        return templates.TemplateResponse(request=request, name="coming_soon.html", context={"request": request})
...
def performance_alarms_3skelion(request: Request):
    try:
        return templates.TemplateResponse(request=request, name="3skelion/performance_alarm.html", context={"request": request})
    except Exception:
        return templates.TemplateResponse(request=request, name="coming_soon.html", context={"request": request})
...
def performance_alarms_f_qual(request: Request):
    try:
        return templates.TemplateResponse(request=request, name="f-qual/performance_alarm.html", context={"request": request})
    except Exception:
        return templates.TemplateResponse(request=request, name="coming_soon.html", context={"request": request})
...
def playback_4skelion(request: Request):
    ...
    try:
        return templates.TemplateResponse(request=request, name="4skelion/playback.html", context={"request": request})
    except Exception:
        return templates.TemplateResponse(request=request, name="coming_soon.html", context={"request": request})
...
def playback_3skelion(request: Request):
    """Render the playback UI."""
    try:
        return templates.TemplateResponse(request=request, name="3skelion/playback.html", context={"request": request})
    except Exception:
        return templates.TemplateResponse(request=request, name="coming_soon.html", context={"request": request})
...
def playback_f_qual(request: Request):
    """Render the playback UI."""
    try:
        return templates.TemplateResponse(request=request, name="f-qual/playback.html", context={"request": request})
    except Exception:
        return templates.TemplateResponse(request=request, name="coming_soon.html", context={"request": request})
...
def settings_4skelion(request: Request):
    ...
    try:
        return templates.TemplateResponse(request=request, name="4skelion/settings.html", context={"request": request})
    except Exception:
        return templates.TemplateResponse(request=request, name="coming_soon.html", context={"request": request})
...
def settings_3skelion(request: Request):
    """Render the settings UI."""
    try:
        return templates.TemplateResponse(request=request, name="3skelion/settings.html", context={"request": request})
    except Exception:
        return templates.TemplateResponse(request=request, name="coming_soon.html", context={"request": request})
...
def settings_f_qual(request: Request):
    """Render the settings UI."""
    try:
        return templates.TemplateResponse(request=request, name="f-qual/settings.html", context={"request": request})
    except Exception:
        return templates.TemplateResponse(request=request, name="coming_soon.html", context={"request": request})
...
def details_4skelion(request: Request):
    ...
    try:
        return templates.TemplateResponse(request=request, name="4skelion/historic_details.html", context={"request": request})
    except Exception:
        return templates.TemplateResponse(request=request, name="coming_soon.html", context={"request": request})
...
def details_3skelion(request: Request):
    """Render the Historic Details UI"""
    try:
        return templates.TemplateResponse(request=request, name="3skelion/historic_details.html", context={"request": request})
    except Exception:
        return templates.TemplateResponse(request=request, name="coming_soon.html", context={"request": request})
...
def details_f_qual(request: Request):
    """Render the Historic Details UI"""
    try:
        return templates.TemplateResponse(request=request, name="f-qual/historic_details.html", context={"request": request})
    except Exception:
        return templates.TemplateResponse(request=request, name="coming_soon.html", context={"request": request})
